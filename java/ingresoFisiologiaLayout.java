...
public class ingresoFisiologiaLayout extends JFrame{
	...
	public JLabel tamañoPetLabel;

	
	public JLabel fechaShowLabel;
	public JTextField pesoPetText;
	public JTextField tamañoPetText;
	...
	public ingresoFisiologiaLayout() {
		...
		this.tamañoPetLabel = new JLabel("Tamaño:");
		...
		this.tamañoPetText = new JTextField();
		this.tamañoPetText.setSize(25,25);
		...
		panel.add(tamañoPetLabel);
		panel.add(tamañoPetText);
