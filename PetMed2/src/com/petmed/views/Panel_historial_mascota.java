...
public class Panel_historial_mascota extends JPanel{
    ...
    public Panel_historial_mascota(){
        ...
        JLabel lbl_nombre= new JLabel("Nombre Mascota:");
        ...
        txt_nombre.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if( !txt_nombre.getText().isEmpty()){
                    ...
                    Panel_historial_mascota.this.cargarTabla(txt_nombre.getText());
                    txt_nombre.setText("");
                    }
                }
            }
    ...
    public void cargarTabla(String mascota){
        
        try{
        String seleccion = "{call select_mascota_historial('"+ mascota +"')}";
